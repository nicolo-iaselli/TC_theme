...
pio.templates['TC_theme'] = go.layout.Template({
    ...
    'layout': {'annotationdefaults': {'arrowcolor': '#2a3f5f', 'arrowhead': 0, 'arrowwidth': 1},
               ...
               'font': {'color': '#555555', 'family': 'Helvetica', 'size': 18},
               'geo': {'bgcolor': 'white',
                       'lakecolor': 'white',
                       'landcolor': 'white',
                       'showlakes': True,
               ...
               'title': {'x': 0.05, 'font': {'family': 'Helvetica', 'size': 25, 'color': '#555555'}},#, 'text': ''},
               'xaxis': {'automargin': True,
                         'gridcolor': '#d4d4d4',
                         'linecolor': '#d4d4d4',
                         'ticks': 'outside',
                         'tickfont': {'family': 'Helvetica', 'size': 18},
                         'title': {'standoff': 15, 'font': {'family': 'Helvetica', 'size': 20}},
