...
pio.templates['TC_theme'] = go.layout.Template({
    ...
    'layout': {'annotationdefaults': {'arrowcolor': '#2a3f5f', 'arrowhead': 0, 'arrowwidth': 1},
               ...
               'font': {'color': '#555555', 'family': 'System', 'size': 18},
               'geo': {'bgcolor': 'white',
                       'lakecolor': 'white',
                       'landcolor': 'white',
                       'showlakes': True,
               ...
               'title': {'x': 0.05, 'font': {'family': 'System', 'size': 25, 'color': '#555555'}},#, 'text': ''},
               'xaxis': {'automargin': True,
                         'gridcolor': '#AAAAAA',
                         'linecolor': '#AAAAAA',
                         'ticks': 'outside',
                         'tickfont': {'family': 'System', 'size': 18},
                         'title': {'standoff': 15, 'font': {'family': 'System', 'size': 20}},
